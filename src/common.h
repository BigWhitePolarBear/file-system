...
#define TRIPLE_INDIRECT_DATA_BLOCK_CNT (TRIPLE_INDIRECT_BLOCK_CNT * DATA_BLOCK_PER_TRIPLE_INDIRECT_BLOCK)

#define INODE_BITMAP_BCNT ((INODE_CNT + BIT_PER_BLOCK - 1) / BIT_PER_BLOCK)
#define DATA_BITMAP_BCNT ((BLOCK_CNT + BIT_PER_BLOCK - 1) / BIT_PER_BLOCK)
